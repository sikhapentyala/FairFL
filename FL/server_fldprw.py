...
def fit_round(rnd: int) -> Dict:
    config = {"rnd": rnd, '0UP': 0.898178, '1UP': 4.1915, '0P': 0.498978, '1P': 2.89412}
    #ws1y0-0.39917,ws1y1-2.79414,ws0y0-0.798325,ws0y1-4.0914
    #ws1y0-0.498978,ws1y1-2.89412,ws0y0-0.898178,ws0y1-4.1915			
    return config
...
if __name__ == "__main__":
    ...
    model.compile("sgd", loss=loss, metrics=[tf.keras.metrics.Recall()])
